...
`registry.codeocean.com/published/1d8aa461-13aa-4a29-9694-499b6379dc8b:v3`
...
docker run --platform linux/amd64 --rm \
  ...
  registry.codeocean.com/published/1d8aa461-13aa-4a29-9694-499b6379dc8b:v3 bash run
```
